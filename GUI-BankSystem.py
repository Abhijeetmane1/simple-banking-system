...
def Cr_Amt(accnt,name):
	...
	creditwn.configure(bg="cyan")
	fr1=tk.Frame(creditwn,bg="blue")
	l_title=tk.Message(creditwn,text="THE INDIAN BANK",relief="raised",width=2000,padx=600,pady=0,fg="cyan",bg="black",justify="center",anchor="center")
...
def De_Amt(accnt,name):
	...
	debitwn.configure(bg="cyan")
	fr1=tk.Frame(debitwn,bg="blue")
	l_title=tk.Message(debitwn,text="THE INDIAN BANK",relief="raised",width=2000,padx=600,pady=0,fg="cyan",bg="black",justify="center",anchor="center")
	l_title.config(font=("Courier","50","bold"))
	l_title.pack(side="top")
...
def disp_tr_hist(accnt):
	...
	disp_wn.configure(bg="cyan")
	fr1=tk.Frame(disp_wn,bg="blue")
	l_title=tk.Message(disp_wn,text="THE INDIAN BANK",relief="raised",width=2000,padx=600,pady=0,fg="cyan",bg="black",justify="center",anchor="center")
	l_title.config(font=("Courier","50","bold"))
	l_title.pack(side="top")
	fr1=tk.Frame(disp_wn)
	fr1.pack(side="top")
	l1=tk.Message(disp_wn,text="Your Transaction History:",padx=100,pady=20,width=1000,bg="blue",fg="cyan",relief="raised")
	l1.pack(side="top")
...
def logged_in_menu(accnt,name):
	...
	rootwn.title("THE INDIAN BANK-"+name)
	rootwn.configure(background='cyan')
	fr1=tk.Frame(rootwn)
	fr1.pack(side="top")
	l_title=tk.Message(rootwn,text="SIMPLE BANKING\n SYSTEM",relief="raised",width=2000,padx=600,pady=0,fg="cyan",bg="black",justify="center",anchor="center")
	l_title.config(font=("Courier","50","bold"))
	l_title.pack(side="top")
	label=tk.Label(text="Logged in as: "+name,relief="raised",bg="black",fg="cyan",anchor="center",justify="center")
	label.pack(side="top")
	...
	img5=tk.PhotoImage(file="tra.gif")
...
def log_in(master):
	...
	loginwn.configure(bg="cyan")
	fr1=tk.Frame(loginwn,bg="blue")
	l_title=tk.Message(loginwn,text="THE INDIAN BANK",relief="raised",width=2000,padx=600,pady=0,fg="cyan",bg="black",justify="center",anchor="center")
	l_title.config(font=("Courier","50","bold"))
	l_title.pack(side="top")
	...
	b.pack(side="top")
	b1=tk.Button(text="HOME",relief="raised",bg="black",fg="cyan",command=lambda: home_return(loginwn))
	b1.pack(side="top")
...
def Create():
	...
	crwn.configure(bg="cyan")
	fr1=tk.Frame(crwn,bg="blue")
	l_title=tk.Message(crwn,text="THE INDIAN BANK",relief="raised",width=2000,padx=600,pady=0,fg="cyan",bg="black",justify="center",anchor="center")
	l_title.config(font=("Courier","50","bold"))
	l_title.pack(side="top")
	l1=tk.Label(crwn,text="Enter Name:",relief="sunken")
	l1.pack(side="top")
	e1=tk.Entry(crwn)
	e1.pack(side="top")
...
def Main_Menu():
	...
	x.place(y=-400)
	l_title=tk.Message(text="SIMPLE BANKING\n SYSTEM",relief="raised",width=2000,padx=700,pady=0,fg="cyan",bg="black",justify="center",anchor="center")
	l_title.config(font=("Courier","50","bold"))
	l_title.pack(side="top")
